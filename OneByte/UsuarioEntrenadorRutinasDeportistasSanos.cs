...
namespace OneByte
{
    public partial class UsuarioEntrenadorRutinasDeportistasSanos : Form
    {
        public UsuarioEntrenadorRutinasDeportistasSanos()
        {
            InitializeComponent();
        ...
        {
            var ruitnasDeporLesio = new UsuarioEntrenadorRutinasDeportistasLesionados();
            ruitnasDeporLesio.Show();
            this.Close();
        }
        ...
        {
            var estadpDeporLesio = new UsuarioEntrenadorEstadoDeportistaLesionado();
            estadpDeporLesio.Show();
            this.Close();
        }
