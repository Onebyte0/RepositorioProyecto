...
namespace OneByte
{
    public partial class UsuarioEntrenadorDescripcionEjercicios : Form
    {
        ...
        private void InitializeDataGridView()
        {
            ...
            dataGridView1.Columns[0].HeaderText = "Ejercicio";
        ...
        private void AddRowsToDataGridView()
        {
            ...
            int rowHeight = availableHeight / 1; // Dividir el espacio entre 1 filas

            // Crear y agregar 1 filas con la altura ajustada
            for (int i = 0; i < 4; i++)
            {
